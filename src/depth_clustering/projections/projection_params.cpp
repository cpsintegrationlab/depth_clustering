...
void
ProjectionParams::SetSpan(const SpanParams& span_params, const SpanParams::Direction& direction)
{
	vector<SpanParams> params_vec =
	{
	{ span_params } };
...
void
ProjectionParams::SetSpan(const vector<SpanParams>& span_params,
...
vector<Radians>
ProjectionParams::FillVector(const SpanParams& span_params)
{
	vector<SpanParams> params_vec =
	{
	{ span_params } };
...
vector<Radians>
ProjectionParams::FillVector(const vector<SpanParams>& span_params)
{
	vector<Radians> res;
...
const Radians
ProjectionParams::AngleFromRow(int row) const
{
...
const Radians
ProjectionParams::AngleFromCol(int col) const
{
	int actual_col = col;
	if (col < 0)
	{
...
size_t
ProjectionParams::RowFromAngle(const Radians& angle) const
{
	return FindClosest(_row_angles, angle);
}

size_t
ProjectionParams::ColFromAngle(const Radians& angle) const
{
	return FindClosest(_col_angles, angle);
}

size_t
ProjectionParams::FindClosest(const vector<Radians>& vec, const Radians& val)
{
	size_t found = 0;
...
ProjectionParams::RowAngleCosines() const
{
	return _row_angles_cosines;
}
const std::vector<float>&
ProjectionParams::ColAngleCosines() const
{
	return _col_angles_cosines;
}
const std::vector<float>&
ProjectionParams::RowAngleSines() const
{
	return _row_angles_sines;
}
const std::vector<float>&
ProjectionParams::ColAngleSines() const
{
	return _col_angles_sines;
}

void
ProjectionParams::FillCosSin()
{
